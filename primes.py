...
# In addition, it can do several other operations including Euler totient function.
...
def about():
    ...
    print("\'primes.factors(n)\' returns all the prime factors of \'n\' with multiplicity")
...
def factor(num):
    if num == 2 or num % 2 == 0:
        ...
        for i in range(3, int(sqrt(num))+1, 2):  # I could iterate over a list of primes
